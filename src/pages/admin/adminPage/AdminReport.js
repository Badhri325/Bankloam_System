...
const AdminReport = () => {
  ...
  const handleDelete = (id) => {
    ...
    alert("Confirm To Delete This Loan Report!");
  };
  ...
  const handleAddSubmit = (e) => {
    ...
    alert("New Loan Report Added Successfully!");
  };

  return (
    <div className="container mt-5">
      <h1 id="tablee" className="text-center">
        Admin Loan Report
      </h1>
      ...
      {/* Add Report Form */}
      {showAddForm && (
        <div className=" bg-light shadow rounded border p-3 mb-4">
